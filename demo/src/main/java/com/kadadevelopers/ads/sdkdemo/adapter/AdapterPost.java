package com.kadadevelopers.ads.sdkdemo.adapter;
...
import com.kadadevelopers.ads.sdk.format.NativeAdViewHolder;
...
import com.kadadevelopers.ads.sdkdemo.model.Post;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            switch (Constant.NATIVE_STYLE) {
                case "news":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.kadadevelopers.ads.sdk.R.layout.view_native_ad_news, parent, false);
                    break;
                case "radio":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.kadadevelopers.ads.sdk.R.layout.view_native_ad_radio, parent, false);
                    break;
                case "video_small":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.kadadevelopers.ads.sdk.R.layout.view_native_ad_video_small, parent, false);
                    break;
                case "video_large":
                    v = LayoutInflater.from(parent.getContext()).inflate(com.kadadevelopers.ads.sdk.R.layout.view_native_ad_video_large, parent, false);
                    break;
                default:
                    v = LayoutInflater.from(parent.getContext()).inflate(com.kadadevelopers.ads.sdk.R.layout.view_native_ad_medium, parent, false);
                    break;
            }
