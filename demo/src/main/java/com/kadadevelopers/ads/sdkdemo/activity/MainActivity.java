package com.kadadevelopers.ads.sdkdemo.activity;

import static com.kadadevelopers.ads.sdk.util.Constant.ADMOB;
import static com.kadadevelopers.ads.sdk.util.Constant.APPLOVIN_DISCOVERY;
import static com.kadadevelopers.ads.sdk.util.Constant.APPLOVIN_MAX;
import static com.kadadevelopers.ads.sdk.util.Constant.FAN;
import static com.kadadevelopers.ads.sdk.util.Constant.GOOGLE_AD_MANAGER;
import static com.kadadevelopers.ads.sdk.util.Constant.IRONSOURCE;
import static com.kadadevelopers.ads.sdk.util.Constant.STARTAPP;
import static com.kadadevelopers.ads.sdk.util.Constant.UNITY;
import static com.kadadevelopers.ads.sdk.util.Constant.WORTISE;
import static com.kadadevelopers.ads.sdkdemo.data.Constant.STYLE_DEFAULT;
import static com.kadadevelopers.ads.sdkdemo.data.Constant.STYLE_NEWS;
import static com.kadadevelopers.ads.sdkdemo.data.Constant.STYLE_RADIO;
import static com.kadadevelopers.ads.sdkdemo.data.Constant.STYLE_VIDEO_LARGE;
import static com.kadadevelopers.ads.sdkdemo.data.Constant.STYLE_VIDEO_SMALL;
...
import com.kadadevelopers.ads.sdk.format.AdNetwork;
import com.kadadevelopers.ads.sdk.format.AppOpenAd;
import com.kadadevelopers.ads.sdk.format.BannerAd;
import com.kadadevelopers.ads.sdk.format.InterstitialAd;
import com.kadadevelopers.ads.sdk.format.MediumRectangleAd;
import com.kadadevelopers.ads.sdk.format.NativeAd;
import com.kadadevelopers.ads.sdk.format.NativeAdView;
import com.kadadevelopers.ads.sdk.format.RewardedAd;
import com.kadadevelopers.ads.sdk.gdpr.GDPR;
import com.kadadevelopers.ads.sdk.util.OnRewardedAdCompleteListener;
import com.kadadevelopers.ads.sdk.util.OnRewardedAdDismissedListener;
import com.kadadevelopers.ads.sdk.util.OnRewardedAdErrorListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannerAdView.addView(View.inflate(this, com.kadadevelopers.ads.sdk.R.layout.view_banner_ad, null));
    ...
    private void setNativeAdStyle(LinearLayout nativeAdView) {
        switch (Constant.NATIVE_STYLE) {
            case "news":
                nativeAdView.addView(View.inflate(this, com.kadadevelopers.ads.sdk.R.layout.view_native_ad_news, null));
                break;
            case "radio":
                nativeAdView.addView(View.inflate(this, com.kadadevelopers.ads.sdk.R.layout.view_native_ad_radio, null));
                break;
            case "video_small":
                nativeAdView.addView(View.inflate(this, com.kadadevelopers.ads.sdk.R.layout.view_native_ad_video_small, null));
                break;
            case "video_large":
                nativeAdView.addView(View.inflate(this, com.kadadevelopers.ads.sdk.R.layout.view_native_ad_video_large, null));
                break;
            default:
                nativeAdView.addView(View.inflate(this, com.kadadevelopers.ads.sdk.R.layout.view_native_ad_medium, null));
                break;
        }
    }
